...
const basePackages = [
  {
    package: 'moment',
    version: '2.24.0',
    urls: ['/downloadAssets/mylib/moment/2.24.0/min/moment.min.js'],
    library: 'moment',
  },
  {
    package: "lodash",
    library: "_",
    urls: [
      '/downloadAssets/platform/c/lodash/4.6.1/lodash.min.js'
    ]
  },
  {
    title: 'fusion组件库',
    ...
    version: '1.25.23',
    urls: [
      '/downloadAssets/code/lib/alifd__next/1.25.23/next.min.css',
      '/downloadAssets/code/lib/alifd__next/1.25.23/next-with-locales.min.js',
    ],
    library: 'Next',
  },
  {
    ...
    version: '4.17.3',
    urls: [
      '/downloadAssets/code/lib/antd/4.17.3/antd.min.js',
      '/downloadAssets/code/lib/antd/4.17.3/antd.min.css',
    ],
    library: 'antd',
  },
];
...
if (baseLibrary === 'rax') {
  basePackages.push({
    ...
    urls: [
      '/downloadAssets/unpkg/@alifd/meet@2.4.2-beta.6/umd/meet.lowcode.js',
      '/downloadAssets/unpkg/@alifd/meet@2.4.2-beta.6/umd/meet.min.css',
    ],
    library: 'Meet',
  });
}
